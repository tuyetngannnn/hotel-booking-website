            ...
            <div className="room-manager-content">
                ...
                <table className="booking-detail-table">
                    <tbody>
                        ...
                        <tr>
                            <td><strong>Phí Phát Sinh:</strong></td>
                            <td>{booking.DamageFee.toLocaleString('vi-VN')}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td><strong>Giá Tổng Gốc:</strong></td>
                            <td>{booking.TotalPrice.toLocaleString('vi-VN')} VND</td>
                        </tr>
                        <tr>
                            <td><strong>Tổng Giá (bao gồm phí phát sinh):</strong></td>
